...
down_revision: str | None = "2025_10_08_0003"
...
def upgrade() -> None:
    ...
    op.add_column(
        "accounts", sa.Column("marketing_opt_in_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "accounts", sa.Column("marketing_opt_in_source", sa.String(length=50), nullable=True)
    )
